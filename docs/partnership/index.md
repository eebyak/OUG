...
The OUG is not designed as the primary provider of teaching. It coordinates and certifies learning delivered largely by partner universities and academic contributors, inside the boundary that [Governance Gap Closure v2](../governance/governance-gap-closure-v2.md) draws at the credential record.

This domain is where that arrangement is made concrete and durable: what a partner gets, what a partner owes, and — a detail easy to overlook and expensive to get wrong — how an individual teaching member of a partner's staff is legally engaged when their teaching now serves two institutions at once.
